...
def start_button(client):
    ...
    if not FORCE_SUB_CHANNEL2 and not FORCE_SUB_GROUP:
        buttons.append([
    ...
    if FORCE_SUB_CHANNEL and FORCE_SUB_GROUP and not FORCE_SUB_CHANNEL2:
        ...
        buttons.append([
            InlineKeyboardButton(text="ʜᴇʟᴘ & ᴄᴏᴍᴀɴᴅs", callback_data="help"),
        ])
        buttons.append([
            InlineKeyboardButton(text="ᴛᴜᴛᴜᴘ", callback_data="close"),
        ])
...
def fsub_button(client, message):
    ...
    if not FORCE_SUB_CHANNEL2 and not FORCE_SUB_CHANNEL:
        try:
            buttons.append([
